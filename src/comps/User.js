	...
	loadedUser(){
		return(
		 <div className='user-panel'>
	     	<img src={this.props.user.url.length>0?this.props.user.url:noimage} className='user-pic'/>
	     	<p>
	     	...
	     	}
	     	{
		     	...
		     	<div className='iconholder'>
		     		<Link replace={true} to={'/download/'+this.props.user.name}>
		     			<img src={downloadIcon} className='user-icon' onClick={this.redirectDownload}/>
		     		</Link>
		     	</div>
	     		:null
	     	}
