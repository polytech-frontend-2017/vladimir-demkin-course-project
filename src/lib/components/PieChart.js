    ...
    _createClass(PieChart, [{
        ...
        value: function addLegend() {
            ...
            this.legend = this.svg.selectAll(".d3act-legend").data(this.color.domain()).enter().append("g").attr("class", "d3act-legend").attr("transform", function (d, i) {
                ...
                var offset = 20;
                var numberOfItems =Object.keys(_this2.data).length;
                var realheight = _this2.props.height;
                var horz = -2 * _this2.legendRectSize+_this2.props.height/2+100;
                var vert = - realheight / 2  + i * height;
        ...
        value: function getHeight(numberOfItems) {
            if (this.showLegend) {
                ...
                return Math.max(this.props.height, legendSpacingExtraHeight + legendRectExtraHeight);
            }
        ...
        value: function create(data) {
            ...
            this.svg = d3.select(this.el).append("svg").attr("width", width).attr("height", svgHeight).append("g").attr("transform", "translate(" + radius + ", " + halfHeight + ")");
